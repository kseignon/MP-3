...
From testing to see where the trails intersect with the contour lines, we found that six out of ten trails intersect. We thus didn't include the other four trails (entry trail, Easy Out, Snowmobile trail, Driveway) in finding the intersections, and assume their change in elevation is zero.
